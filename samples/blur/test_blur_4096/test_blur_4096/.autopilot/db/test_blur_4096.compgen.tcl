...
set name test_blur_4096_fadd_32ns_32ns_32_7_full_dsp_1
...
set name test_blur_4096_fdiv_32ns_32ns_32_16_no_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 201 \
			corename test_blur_4096_ctrl_axilite \
			name test_blur_4096_ctrl_s_axi \
			ports {$port_ctrl} \
			op interface \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler test_blur_4096_ctrl_s_axi BINDTYPE interface TYPE interface_s_axilite
}
