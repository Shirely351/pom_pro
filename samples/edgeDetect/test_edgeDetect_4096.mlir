module {
  func @test_edgeDetect_4096(%arg0: f32, %arg1: memref<4096x4096x3xf32, affine_map<(d0, d1, d2) -> (d0 mod 2, d1 mod 2, d2 mod 3, d0 floordiv 2, d1 floordiv 2, d2 floordiv 3)>>, %arg2: memref<4096x4096x3xf32, affine_map<(d0, d1, d2) -> (d0 mod 4, d1 mod 4, d2 mod 3, d0 floordiv 4, d1 floordiv 4, d2 floordiv 3)>>, %arg3: memref<4096x4096x3xf32, affine_map<(d0, d1, d2) -> (d0 mod 3, d1 mod 3, d2 mod 3, d0 floordiv 3, d1 floordiv 3, d2 floordiv 3)>>) attributes {resource = #hls.r<lut=0, dsp=12, bram=0>, timing = #hls.t<0 -> 104755289, 104755289, 104755289>, top_func} {
