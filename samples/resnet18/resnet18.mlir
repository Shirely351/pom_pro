    ...
    affine.for %arg41 = 0 to 64 {
      affine.for %arg42 = 0 to 32 {
        affine.for %arg43 = 0 to 32 {
          ...
          affine.store %1, %arg9[%arg41, %arg42, %arg43] {max_mux_size = 4 : i64, partition_indices = [-1, 0, 0]} : memref<64x32x32xf32, affine_map<(d0, d1, d2) -> (d0 mod 4, 0, 0, d0 floordiv 4, d1, d2)>>
    ...
    affine.for %arg41 = 0 to 64 {
      affine.for %arg42 = 0 to 32 {
        affine.for %arg43 = 0 to 32 {
          ...
          %1 = arith.maxf %0, %arg0 : f32
          affine.store %1, %arg20[%arg41, %arg42, %arg43] {max_mux_size = 4 : i64, partition_indices = [-1, 0, 0]} : memref<64x32x32xf32, affine_map<(d0, d1, d2) -> (d0 mod 4, 0, 0, d0 floordiv 4, d1, d2)>>
    ...
    affine.for %arg41 = 0 to 64 {
      affine.for %arg42 = 0 to 32 {
        affine.for %arg43 = 0 to 32 {
          ...
          %1 = arith.maxf %0, %arg0 : f32
          affine.store %1, %arg31[%arg41, %arg42, %arg43] {partition_indices = [0, 0, 0]} : memref<64x32x32xf32, affine_map<(d0, d1, d2) -> (0, 0, 0, d0, d1, d2)>>
    ...
    affine.for %arg41 = 0 to 64 {
      affine.for %arg42 = 0 to 32 {
        affine.for %arg43 = 0 to 32 {
          ...
          %1 = arith.maxf %0, %arg0 : f32
          affine.store %1, %arg32[%arg41, %arg42, %arg43] {max_mux_size = 4 : i64, partition_indices = [-1, 0, 0]} : memref<64x32x32xf32, affine_map<(d0, d1, d2) -> (d0 mod 4, 0, 0, d0 floordiv 4, d1, d2)>>
    ...
    affine.for %arg41 = 0 to 64 {
      affine.for %arg42 = 0 to 32 {
        affine.for %arg43 = 0 to 32 {
          ...
          %1 = arith.maxf %0, %arg0 : f32
          affine.store %1, %arg34[%arg41, %arg42, %arg43] {partition_indices = [0, 0, 0]} : memref<64x32x32xf32, affine_map<(d0, d1, d2) -> (0, 0, 0, d0, d1, d2)>>
        } {parallel}
      } {parallel}
    } {parallel}
    ...
    affine.for %arg41 = 0 to 128 {
      affine.for %arg42 = 0 to 16 {
        affine.for %arg43 = 0 to 16 {
          ...
          %1 = arith.maxf %0, %arg0 : f32
          affine.store %1, %arg35[%arg41, %arg42, %arg43] {max_mux_size = 4 : i64, partition_indices = [-1, 0, 0]} : memref<128x16x16xf32, affine_map<(d0, d1, d2) -> (d0 mod 4, 0, 0, d0 floordiv 4, d1, d2)>>
    ...
    affine.for %arg41 = 0 to 128 {
      affine.for %arg42 = 0 to 16 {
        affine.for %arg43 = 0 to 16 {
          ...
          %1 = arith.maxf %0, %arg0 : f32
          affine.store %1, %arg11[%arg41, %arg42, %arg43] {partition_indices = [0, 0, 0]} : memref<128x16x16xf32, affine_map<(d0, d1, d2) -> (0, 0, 0, d0, d1, d2)>>
    ...
    affine.for %arg41 = 0 to 128 {
      affine.for %arg42 = 0 to 16 {
        affine.for %arg43 = 0 to 16 {
          ...
          %1 = arith.maxf %0, %arg0 : f32
          affine.store %1, %arg12[%arg41, %arg42, %arg43] {max_mux_size = 4 : i64, partition_indices = [-1, 0, 0]} : memref<128x16x16xf32, affine_map<(d0, d1, d2) -> (d0 mod 4, 0, 0, d0 floordiv 4, d1, d2)>>
    ...
    affine.for %arg41 = 0 to 128 {
      affine.for %arg42 = 0 to 16 {
        affine.for %arg43 = 0 to 16 {
          ...
          %1 = arith.maxf %0, %arg0 : f32
          affine.store %1, %arg14[%arg41, %arg42, %arg43] {partition_indices = [0, 0, 0]} : memref<128x16x16xf32, affine_map<(d0, d1, d2) -> (0, 0, 0, d0, d1, d2)>>
        } {parallel}
      } {parallel}
    } {parallel}
    ...
    affine.for %arg41 = 0 to 256 {
      affine.for %arg42 = 0 to 8 {
        affine.for %arg43 = 0 to 8 {
          ...
          %1 = arith.maxf %0, %arg0 : f32
          affine.store %1, %arg15[%arg41, %arg42, %arg43] {max_mux_size = 4 : i64, partition_indices = [-1, 0, 0]} : memref<256x8x8xf32, affine_map<(d0, d1, d2) -> (d0 mod 4, 0, 0, d0 floordiv 4, d1, d2)>>
    ...
    affine.for %arg41 = 0 to 256 {
      affine.for %arg42 = 0 to 8 {
        affine.for %arg43 = 0 to 8 {
          ...
          %1 = arith.maxf %0, %arg0 : f32
          affine.store %1, %arg18[%arg41, %arg42, %arg43] {partition_indices = [0, 0, 0]} : memref<256x8x8xf32, affine_map<(d0, d1, d2) -> (0, 0, 0, d0, d1, d2)>>
    ...
    affine.for %arg41 = 0 to 256 {
      affine.for %arg42 = 0 to 8 {
        affine.for %arg43 = 0 to 8 {
          ...
          %1 = arith.maxf %0, %arg0 : f32
          affine.store %1, %arg19[%arg41, %arg42, %arg43] {max_mux_size = 4 : i64, partition_indices = [-1, 0, 0]} : memref<256x8x8xf32, affine_map<(d0, d1, d2) -> (d0 mod 4, 0, 0, d0 floordiv 4, d1, d2)>>
        } {parallel}
      } {parallel}
    } {parallel}
    affine.for %arg41 = 0 to 256 {
    ...
    affine.for %arg41 = 0 to 256 {
      affine.for %arg42 = 0 to 8 {
        affine.for %arg43 = 0 to 8 {
          ...
          %1 = arith.maxf %0, %arg0 : f32
          affine.store %1, %arg22[%arg41, %arg42, %arg43] {partition_indices = [0, 0, 0]} : memref<256x8x8xf32, affine_map<(d0, d1, d2) -> (0, 0, 0, d0, d1, d2)>>
        } {parallel}
      } {parallel}
    } {parallel}
    ...
    affine.for %arg41 = 0 to 512 {
      affine.for %arg42 = 0 to 4 {
        affine.for %arg43 = 0 to 4 {
          ...
          %1 = arith.maxf %0, %arg0 : f32
          affine.store %1, %arg23[%arg41, %arg42, %arg43] {max_mux_size = 4 : i64, partition_indices = [-1, 0, 0]} : memref<512x4x4xf32, affine_map<(d0, d1, d2) -> (d0 mod 4, 0, 0, d0 floordiv 4, d1, d2)>>
    ...
    affine.for %arg41 = 0 to 512 {
      affine.for %arg42 = 0 to 4 {
        affine.for %arg43 = 0 to 4 {
          ...
          %1 = arith.maxf %0, %arg0 : f32
          affine.store %1, %arg26[%arg41, %arg42, %arg43] {partition_indices = [0, 0, 0]} : memref<512x4x4xf32, affine_map<(d0, d1, d2) -> (0, 0, 0, d0, d1, d2)>>
    ...
    affine.for %arg41 = 0 to 512 {
      affine.for %arg42 = 0 to 4 {
        affine.for %arg43 = 0 to 4 {
          ...
          %1 = arith.maxf %0, %arg0 : f32
          affine.store %1, %arg27[%arg41, %arg42, %arg43] {max_mux_size = 4 : i64, partition_indices = [-1, 0, 0]} : memref<512x4x4xf32, affine_map<(d0, d1, d2) -> (d0 mod 4, 0, 0, d0 floordiv 4, d1, d2)>>
    ...
    affine.for %arg41 = 0 to 512 {
      affine.for %arg42 = 0 to 4 {
        affine.for %arg43 = 0 to 4 {
          ...
          %1 = arith.maxf %0, %arg0 {timing = #hls.t<1 -> 1, 0, 0>} : f32
          affine.store %1, %arg29[%arg41, %arg42, %arg43] {partition_indices = [0, 0, 0], timing = #hls.t<0 -> 1, 1, 1>} : memref<512x4x4xf32, affine_map<(d0, d1, d2) -> (0, 0, 0, d0, d1, d2)>>
