module {
  func @test_gaussian_4096(%arg0: f32, %arg1: memref<4096x4096x3xf32, affine_map<(d0, d1, d2) -> (d0 mod 3, d1 mod 3, d2 mod 3, d0 floordiv 3, d1 floordiv 3, d2 floordiv 3)>>, %arg2: memref<7xf32, affine_map<(d0) -> (0, d0)>>, %arg3: memref<7xf32, affine_map<(d0) -> (0, d0)>>, %arg4: memref<4096x4096x3xf32, affine_map<(d0, d1, d2) -> (d0 mod 3, d1 mod 3, d2 mod 3, d0 floordiv 3, d1 floordiv 3, d2 floordiv 3)>>, %arg5: memref<4096x4096x3xf32, affine_map<(d0, d1, d2) -> (d0 mod 3, d1 mod 3, d2 mod 3, d0 floordiv 3, d1 floordiv 3, d2 floordiv 3)>>) attributes {resource = #hls.r<lut=0, dsp=45, bram=0>, timing = #hls.t<0 -> 79884097, 79884097, 79884097>, top_func} {
