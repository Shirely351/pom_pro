module {
  func @test_seidel_4096(%arg0: f32, %arg1: memref<4096x4096xf32, affine_map<(d0, d1) -> (d0 mod 3, d1 mod 3, d0 floordiv 3, d1 floordiv 3)>>, %arg2: memref<4096x4096xf32>) attributes {top_func} {
