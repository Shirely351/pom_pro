module {
  func @test_bicg_32(%arg0: memref<32x32xf32, affine_map<(d0, d1) -> (d0 mod 16, d1 mod 16, d0 floordiv 16, d1 floordiv 16)>>, %arg1: memref<32xf32, affine_map<(d0) -> (0, d0)>>, %arg2: memref<32xf32, affine_map<(d0) -> (d0 mod 16, d0 floordiv 16)>>, %arg3: memref<32xf32, affine_map<(d0) -> (0, d0)>>, %arg4: memref<32xf32, affine_map<(d0) -> (d0 mod 16, d0 floordiv 16)>>) attributes {resource = #hls.r<lut=0, dsp=80, bram=0>, timing = #hls.t<0 -> 204, 204, 204>, top_func} {
    affine.for %arg5 = 0 to 32 {
      affine.for %arg6 = 0 to 2 {
        %0 = affine.load %arg0[%arg5, %arg6 * 16] {max_mux_size = 16 : i64, partition_indices = [-1, 0], timing = #hls.t<72 -> 74, 2, 1>} : memref<32x32xf32, affine_map<(d0, d1) -> (d0 mod 16, d1 mod 16, d0 floordiv 16, d1 floordiv 16)>>
        ...
        %5 = affine.load %arg0[%arg6 * 16, %arg5] {max_mux_size = 16 : i64, partition_indices = [0, -1], timing = #hls.t<70 -> 72, 2, 1>} : memref<32x32xf32, affine_map<(d0, d1) -> (d0 mod 16, d1 mod 16, d0 floordiv 16, d1 floordiv 16)>>
        ...
        %10 = affine.load %arg0[%arg5, %arg6 * 16 + 1] {max_mux_size = 16 : i64, partition_indices = [-1, 1], timing = #hls.t<68 -> 70, 2, 1>} : memref<32x32xf32, affine_map<(d0, d1) -> (d0 mod 16, d1 mod 16, d0 floordiv 16, d1 floordiv 16)>>
        ...
        %14 = affine.load %arg0[%arg6 * 16 + 1, %arg5] {max_mux_size = 16 : i64, partition_indices = [1, -1], timing = #hls.t<66 -> 68, 2, 1>} : memref<32x32xf32, affine_map<(d0, d1) -> (d0 mod 16, d1 mod 16, d0 floordiv 16, d1 floordiv 16)>>
        ...
        %18 = affine.load %arg0[%arg5, %arg6 * 16 + 2] {max_mux_size = 16 : i64, partition_indices = [-1, 2], timing = #hls.t<64 -> 66, 2, 1>} : memref<32x32xf32, affine_map<(d0, d1) -> (d0 mod 16, d1 mod 16, d0 floordiv 16, d1 floordiv 16)>>
        ...
        %22 = affine.load %arg0[%arg6 * 16 + 2, %arg5] {max_mux_size = 16 : i64, partition_indices = [2, -1], timing = #hls.t<62 -> 64, 2, 1>} : memref<32x32xf32, affine_map<(d0, d1) -> (d0 mod 16, d1 mod 16, d0 floordiv 16, d1 floordiv 16)>>
        ...
        %26 = affine.load %arg0[%arg5, %arg6 * 16 + 3] {max_mux_size = 16 : i64, partition_indices = [-1, 3], timing = #hls.t<60 -> 62, 2, 1>} : memref<32x32xf32, affine_map<(d0, d1) -> (d0 mod 16, d1 mod 16, d0 floordiv 16, d1 floordiv 16)>>
        ...
        %30 = affine.load %arg0[%arg6 * 16 + 3, %arg5] {max_mux_size = 16 : i64, partition_indices = [3, -1], timing = #hls.t<58 -> 60, 2, 1>} : memref<32x32xf32, affine_map<(d0, d1) -> (d0 mod 16, d1 mod 16, d0 floordiv 16, d1 floordiv 16)>>
        ...
        %34 = affine.load %arg0[%arg5, %arg6 * 16 + 4] {max_mux_size = 16 : i64, partition_indices = [-1, 4], timing = #hls.t<56 -> 58, 2, 1>} : memref<32x32xf32, affine_map<(d0, d1) -> (d0 mod 16, d1 mod 16, d0 floordiv 16, d1 floordiv 16)>>
        ...
        %38 = affine.load %arg0[%arg6 * 16 + 4, %arg5] {max_mux_size = 16 : i64, partition_indices = [4, -1], timing = #hls.t<54 -> 56, 2, 1>} : memref<32x32xf32, affine_map<(d0, d1) -> (d0 mod 16, d1 mod 16, d0 floordiv 16, d1 floordiv 16)>>
        ...
        %42 = affine.load %arg0[%arg5, %arg6 * 16 + 5] {max_mux_size = 16 : i64, partition_indices = [-1, 5], timing = #hls.t<52 -> 54, 2, 1>} : memref<32x32xf32, affine_map<(d0, d1) -> (d0 mod 16, d1 mod 16, d0 floordiv 16, d1 floordiv 16)>>
        ...
        %46 = affine.load %arg0[%arg6 * 16 + 5, %arg5] {max_mux_size = 16 : i64, partition_indices = [5, -1], timing = #hls.t<50 -> 52, 2, 1>} : memref<32x32xf32, affine_map<(d0, d1) -> (d0 mod 16, d1 mod 16, d0 floordiv 16, d1 floordiv 16)>>
        ...
        %50 = affine.load %arg0[%arg5, %arg6 * 16 + 6] {max_mux_size = 16 : i64, partition_indices = [-1, 6], timing = #hls.t<48 -> 50, 2, 1>} : memref<32x32xf32, affine_map<(d0, d1) -> (d0 mod 16, d1 mod 16, d0 floordiv 16, d1 floordiv 16)>>
        ...
        %54 = affine.load %arg0[%arg6 * 16 + 6, %arg5] {max_mux_size = 16 : i64, partition_indices = [6, -1], timing = #hls.t<46 -> 48, 2, 1>} : memref<32x32xf32, affine_map<(d0, d1) -> (d0 mod 16, d1 mod 16, d0 floordiv 16, d1 floordiv 16)>>
        ...
        %58 = affine.load %arg0[%arg5, %arg6 * 16 + 7] {max_mux_size = 16 : i64, partition_indices = [-1, 7], timing = #hls.t<44 -> 46, 2, 1>} : memref<32x32xf32, affine_map<(d0, d1) -> (d0 mod 16, d1 mod 16, d0 floordiv 16, d1 floordiv 16)>>
        ...
        %62 = affine.load %arg0[%arg6 * 16 + 7, %arg5] {max_mux_size = 16 : i64, partition_indices = [7, -1], timing = #hls.t<42 -> 44, 2, 1>} : memref<32x32xf32, affine_map<(d0, d1) -> (d0 mod 16, d1 mod 16, d0 floordiv 16, d1 floordiv 16)>>
        ...
        %66 = affine.load %arg0[%arg5, %arg6 * 16 + 8] {max_mux_size = 16 : i64, partition_indices = [-1, 8], timing = #hls.t<40 -> 42, 2, 1>} : memref<32x32xf32, affine_map<(d0, d1) -> (d0 mod 16, d1 mod 16, d0 floordiv 16, d1 floordiv 16)>>
        ...
        %70 = affine.load %arg0[%arg6 * 16 + 8, %arg5] {max_mux_size = 16 : i64, partition_indices = [8, -1], timing = #hls.t<38 -> 40, 2, 1>} : memref<32x32xf32, affine_map<(d0, d1) -> (d0 mod 16, d1 mod 16, d0 floordiv 16, d1 floordiv 16)>>
        ...
        %74 = affine.load %arg0[%arg5, %arg6 * 16 + 9] {max_mux_size = 16 : i64, partition_indices = [-1, 9], timing = #hls.t<36 -> 38, 2, 1>} : memref<32x32xf32, affine_map<(d0, d1) -> (d0 mod 16, d1 mod 16, d0 floordiv 16, d1 floordiv 16)>>
        ...
        %78 = affine.load %arg0[%arg6 * 16 + 9, %arg5] {max_mux_size = 16 : i64, partition_indices = [9, -1], timing = #hls.t<34 -> 36, 2, 1>} : memref<32x32xf32, affine_map<(d0, d1) -> (d0 mod 16, d1 mod 16, d0 floordiv 16, d1 floordiv 16)>>
        ...
        %82 = affine.load %arg0[%arg5, %arg6 * 16 + 10] {max_mux_size = 16 : i64, partition_indices = [-1, 10], timing = #hls.t<32 -> 34, 2, 1>} : memref<32x32xf32, affine_map<(d0, d1) -> (d0 mod 16, d1 mod 16, d0 floordiv 16, d1 floordiv 16)>>
        ...
        %86 = affine.load %arg0[%arg6 * 16 + 10, %arg5] {max_mux_size = 16 : i64, partition_indices = [10, -1], timing = #hls.t<30 -> 32, 2, 1>} : memref<32x32xf32, affine_map<(d0, d1) -> (d0 mod 16, d1 mod 16, d0 floordiv 16, d1 floordiv 16)>>
        ...
        %90 = affine.load %arg0[%arg5, %arg6 * 16 + 11] {max_mux_size = 16 : i64, partition_indices = [-1, 11], timing = #hls.t<28 -> 30, 2, 1>} : memref<32x32xf32, affine_map<(d0, d1) -> (d0 mod 16, d1 mod 16, d0 floordiv 16, d1 floordiv 16)>>
        ...
        %94 = affine.load %arg0[%arg6 * 16 + 11, %arg5] {max_mux_size = 16 : i64, partition_indices = [11, -1], timing = #hls.t<26 -> 28, 2, 1>} : memref<32x32xf32, affine_map<(d0, d1) -> (d0 mod 16, d1 mod 16, d0 floordiv 16, d1 floordiv 16)>>
        ...
        %98 = affine.load %arg0[%arg5, %arg6 * 16 + 12] {max_mux_size = 16 : i64, partition_indices = [-1, 12], timing = #hls.t<24 -> 26, 2, 1>} : memref<32x32xf32, affine_map<(d0, d1) -> (d0 mod 16, d1 mod 16, d0 floordiv 16, d1 floordiv 16)>>
        ...
        %102 = affine.load %arg0[%arg6 * 16 + 12, %arg5] {max_mux_size = 16 : i64, partition_indices = [12, -1], timing = #hls.t<22 -> 24, 2, 1>} : memref<32x32xf32, affine_map<(d0, d1) -> (d0 mod 16, d1 mod 16, d0 floordiv 16, d1 floordiv 16)>>
        ...
        %106 = affine.load %arg0[%arg5, %arg6 * 16 + 13] {max_mux_size = 16 : i64, partition_indices = [-1, 13], timing = #hls.t<20 -> 22, 2, 1>} : memref<32x32xf32, affine_map<(d0, d1) -> (d0 mod 16, d1 mod 16, d0 floordiv 16, d1 floordiv 16)>>
        ...
        %110 = affine.load %arg0[%arg6 * 16 + 13, %arg5] {max_mux_size = 16 : i64, partition_indices = [13, -1], timing = #hls.t<18 -> 20, 2, 1>} : memref<32x32xf32, affine_map<(d0, d1) -> (d0 mod 16, d1 mod 16, d0 floordiv 16, d1 floordiv 16)>>
        ...
        %114 = affine.load %arg0[%arg5, %arg6 * 16 + 14] {max_mux_size = 16 : i64, partition_indices = [-1, 14], timing = #hls.t<16 -> 18, 2, 1>} : memref<32x32xf32, affine_map<(d0, d1) -> (d0 mod 16, d1 mod 16, d0 floordiv 16, d1 floordiv 16)>>
        ...
        %118 = affine.load %arg0[%arg6 * 16 + 14, %arg5] {max_mux_size = 16 : i64, partition_indices = [14, -1], timing = #hls.t<14 -> 16, 2, 1>} : memref<32x32xf32, affine_map<(d0, d1) -> (d0 mod 16, d1 mod 16, d0 floordiv 16, d1 floordiv 16)>>
        ...
        %122 = affine.load %arg0[%arg5, %arg6 * 16 + 15] {max_mux_size = 16 : i64, partition_indices = [-1, 15], timing = #hls.t<12 -> 14, 2, 1>} : memref<32x32xf32, affine_map<(d0, d1) -> (d0 mod 16, d1 mod 16, d0 floordiv 16, d1 floordiv 16)>>
        ...
        %126 = affine.load %arg0[%arg6 * 16 + 15, %arg5] {max_mux_size = 16 : i64, partition_indices = [15, -1], timing = #hls.t<10 -> 12, 2, 1>} : memref<32x32xf32, affine_map<(d0, d1) -> (d0 mod 16, d1 mod 16, d0 floordiv 16, d1 floordiv 16)>>
      ...
      } {loop_directive = #hls.ld<pipeline=true, targetII=1, dataflow=false, flatten=false>, loop_info = #hls.l<flattenTripCount=2, iterLatency=74, minII=2>, parallel, timing = #hls.t<0 -> 78, 78, 78>}
    } {loop_directive = #hls.ld<pipeline=false, targetII=1, dataflow=false, flatten=true>, loop_info = #hls.l<flattenTripCount=64, iterLatency=74, minII=2>, resource = #hls.r<lut=0, dsp=80, bram=0>, timing = #hls.t<0 -> 202, 202, 202>}
    return
  }
}