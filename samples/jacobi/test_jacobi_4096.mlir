module {
  func @test_jacobi_4096(%arg0: f32, %arg1: memref<4096xf32, affine_map<(d0) -> (d0 mod 4, d0 floordiv 4)>>, %arg2: memref<4096xf32, affine_map<(d0) -> (d0 mod 4, d0 floordiv 4)>>) attributes {resource = #hls.r<lut=0, dsp=5, bram=0>, timing = #hls.t<0 -> 33538067, 33538067, 33538067>, top_func} {
